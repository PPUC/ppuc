...
FLITE_EXPECTED_SHA="${FLITE_SHA}-macos${MACOSX_DEPLOYMENT_TARGET}"
...
ppuc_clean_runtime_lib_dir "../third-party/runtime-libs/macos-arm64" macos
...
ppuc_prepare_vpinball_media_plugins macos arm64
