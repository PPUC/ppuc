...
//
// Edit the glyph art in tools/mkfont.py and regenerate:
//     python3 tools/mkfont.py > src/dmd/DmdFont5x7.h
//
// 5x7 cell, one byte per row, bit 4 (0x10) leftmost. Characters outside the
// table render as a space.

#pragma once

#include <cstdint>

inline constexpr uint8_t kDmdFont5x7First = 0x20;
inline constexpr uint8_t kDmdFont5x7Last = 0x7E;
inline constexpr uint8_t kDmdFont5x7Width = 5;
inline constexpr uint8_t kDmdFont5x7Height = 7;

inline constexpr uint8_t kDmdFont5x7[][7] = {
    ...
    {0x00, 0x00, 0x00, 0x00, 0x0C, 0x0C, 0x10},  // 0x2C ,
    ...
    {0x0E, 0x11, 0x10, 0x13, 0x11, 0x11, 0x0F},  // 0x47 G
